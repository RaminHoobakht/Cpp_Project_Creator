...
namespace scripts {
    ...
    const static std::string script_new_sh{
        ...
        "\n"
        "[[maybe_unused]] static constexpr uint serial_version{1001};\n"
        "[[maybe_unused]] static constexpr char nl{'\\n'};\n"
        "[[maybe_unused]] static constexpr char rt { '\\r' };\n"
        ...
        "int main() {\n"
        "\n"
        "    std::cout << nl <<\\\"version: \\\" << serial_version << nl << nl;"
        "\n"
        "\n"
        "    std::cout << nl <<\\\"The End ...\\\" << std::endl;\n"
        "    return (EXIT_SUCCESS);\n"
        "}\" >> src/app/main_$1.cpp\n"
        "\n"
        "git add --all\n"
